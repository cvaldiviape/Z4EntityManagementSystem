...
public interface TbTypeContributorService extends BaseService<TypeContributorsPageResponseDTO, TypeContributorResponseDTO, TypeContributorRequestDTO, Integer> {
